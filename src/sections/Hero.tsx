...
const Hero = () => {
    ...
    return (
        <>
            <section id='home' className=' md:min-h-screen relative px-5 md:px-15 bg-black/95 z'>
                ...
                {/* top right */}
                <div className='top-right-leaf z-10 absolute h-35 w-25 md:h-[25rem] md:w-57 top-[22%] md:top-10 right-0'>
                    <Image
                ...
                {/* top left*/}
                <div className='top-left-leaf z-10 absolute h-30 w-30 md:h-66 md:w-66 top-[34%] md:top-60 left-0 md:-left-5'>
                    <Image
